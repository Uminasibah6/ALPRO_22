...
public class SiakadUAS{
    ...
    public static void lihatData(){
        System.out.println("Berikut ini Data Diri Anda : ");
        int i = 0;
        while (i<jumlahData){
            int nomer = i+1;
    ...
    public static void editData(){
        ...
        System.out.print("Masukan Nomor Yang Akan Diedit = ");
    ...
    public static void UjianAkhirSemester(){
        if(jumlahData == 0){ 
